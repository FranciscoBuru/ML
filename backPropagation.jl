...
params1, params2 = dameParametros(numero,inicio,fin)
err, resp , vals = evalua(params1, params2, vals1, alpha1)
...
rectifica(.5, vals[1], vals[2], vals[3], vals[4], logsig, purelin)
print("__\n")
print("__\n")
...
function dameParametros(num, a, b)
    Random.seed!(42)
